...
contact_residues= json.loads(open('equiv_contacts_dict_lsyozyme_all_contacts.json').read())
...
def get_contacts( name):
    ...
    plt.suptitle("All Contacts", fontsize = 36) #title
    ...
    g.get_figure().savefig("v1_on_antigen_heatmap_"+"_"+name+"_all_contacts.png")
